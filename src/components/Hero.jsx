...
import DataImage from '../data/appData.js'
import { usePersona } from '../features/persona/usePersona.js'
    ...
    return (
        <div className="hero grid md:grid-cols-2 justify-center items-center pt-5 xl:gap-20 gap-10 grid-cols-1">
            <div className="animate__animated animate__fadeInUp">
                ...
                <h1 className="md:text-5xl/tigh text-4xl/tight md:text-left text-center font-bold mb-6">Hi, Saya {currentPersona.name}</h1>
